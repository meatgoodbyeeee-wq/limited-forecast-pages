...
const predicted=applyAdoptedGih(predictCards(pool,incumbent));
...
const forecast=liveForecast({...merged,phase:'PREVIEW',cards:predicted,model_version:`${incumbent.version} + ${adoptedGihVersion}`,checked_at:new Date().toISOString()},null,policy);
