...
export function predictDeckColors(cards){
 ...
 const rows=means.map(({pair,pair_gih})=>{
  const predicted_wr_pct=baseline+intercept+coefficient*(pair_gih-allPairMean);
  return {pair,predicted_wr_pct,delta_pp:predicted_wr_pct-baseline,range80:[predicted_wr_pct-error80,predicted_wr_pct+error80]};
 ...
 return {model_version:deckColorModelVersion,rows};
}
